...
@section('title', 'Criar Módulo - Painel Administrativo')
...
<div class="row mb-4">
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h2 class="fw-bold mb-1">Criar Novo Módulo</h2>
                <p class="text-muted mb-0">Adicione um novo módulo ao curso</p>
            </div>
            <div>
