        ...
        <div class="card stats-card mb-4">
            <div class="card-body">
                <div class="ratio ratio-16x9 mb-3">
                    <!-- Player de vídeo -->
                    <video id="mainVideo" class="w-100 rounded" autoplay controls poster="{{ $course->image_url ?? '' }}">
                        <source id="mainVideoSource" src="{{ $modules->first()?->lessons->first()?->video_url ?? 'https://www.w3schools.com/html/mov_bbb.mp4' }}" type="video/mp4">
                ...
                <div class="d-flex align-items-center mb-2">
                    ...
                    <span class="text-muted"><i class="bi bi-person me-1"></i>{{ $course->instructor ?? 'Instrutor(a) não informado(a)' }}</span>
                </div>
                <div class="mb-2">
                    @if($course->tags)
